...
class Particle:
  def __init__(self, dim, minx, maxx, seed,fixed_joint ,avg_angle):
...
def Solve(max_epochs, n, dim, minx, maxx, fixed_joint, ref_pose,avg_angle, score_weight):
  ...
  swarm = [Particle(dim, minx, maxx, i, fixed_joint ,avg_angle) for i in range(n)]
...
max_epochs = 10
fixed_joint = 3
ref_pose = original_posture_config[3]
